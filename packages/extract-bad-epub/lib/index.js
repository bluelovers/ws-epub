...
const jquery_1 = __importDefault(require("@node-novel/epub-util/lib/extract/jquery"));
const html_1 = require("@node-novel/epub-util/lib/extract/html");
const text_1 = __importDefault(require("@node-novel/epub-util/lib/extract/text"));
    ...
    return bluebird_1.default.resolve(Object.entries(options.cache._attach))
        ...
        await bluebird_1.default
            ...
            return bluebird_1.default
                ...
                .then(buf => {
                debug_color2_1.default.gray(`[img][${padNum(index)}/${padNum(length)}]`, _img_path);
                return fs_iconv_1.outputFile(_img_path, buf);
            })
                .catch(e => {
                debug_color2_1.default.error(e.message, {
                    dir,
                    name: src,
                    _img,
                });
...
function load(file, cache = {}) {
    return bluebird_1.default.resolve(fs_iconv_1.readFile(file)).then(buf => buffer(buf, cache));
}
exports.load = load;
...
function saveTxt(options) {
    return bluebird_1.default
        ...
        debug_color2_1.default.gray.log(`[txt][${padNum(index)}/${padNum(length)}]`, filename);
