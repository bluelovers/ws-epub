...
function create(options, cache = {}) {
    return Bluebird.resolve().then(async function () {
        ...
        //console.dir(options);
        util_1.console.info(meta.novel.title);
         ...
         */
            ...
            return node_novel_globby_1.foreachArrayDeepAsync(_ls, async ({ value, index, array, cache, }) => {
                ...
                await epub_1._handleVolumeImageEach(temp.cache_volume_row, {
                    epub,
                    processReturn,
                });
        ...
        util_1.console.success(filename, now.format(), stat);
        return {
            file,
            filename,
            epub,
