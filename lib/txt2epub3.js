...
async function getNovelConf(options, cache = {}) {
    let meta;
    let confPath;
...
function create(options, cache = {}) {
    return Promise.resolve().then(async function () {
        ...
        let epub = new epub_maker2_1.default()
            ...
            .withUuid(epub_maker2_1.hashSum([
            meta.novel.title,
            meta.novel.author,
        ]))
        ...
        await novelGlobby
            ...
            return Promise
                ...
                let volume = new epub_maker2_1.default.Section('auto-toc', vid, {
                    title: volume_title,
                }, false, true);
                await novelGlobby.globby([
                    'cover.*',
                ...
                await Promise.mapSeries(ls, async function (row) {
                    ...
                    let chapter = new epub_maker2_1.default.Section('chapter', `chapter${(idx++).toString().padStart(4, '0')}`, {
                        title: name,
                ...
                await novelGlobby.globby([
                    ...
                    if (arr.length) {
                        ...
                        let chapter = new epub_maker2_1.default.Section('non-specific backmatter', `image${(idx++).toString().padStart(4, '0')}`, {
                            title: '插圖',
