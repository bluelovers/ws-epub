...
function createContributeSection(options) {
    ...
    let title = mdReturn.mdEnv.title || "CONTRIBUTE" /* CONTRIBUTE */;
    let chapter = new epub_maker2_1.default.Section("non-specific backmatter" /* NON_SPECIFIC_BACKMATTER */, makePrefixID(processReturn.temp.count_idx++, "contribute" /* CONTRIBUTE */), {
        title,
